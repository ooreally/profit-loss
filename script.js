...
const clickHandler = () => {
    ...
    {if(sellingPrice > costPrice)
    {
        ...
        var msg = "Yay! You earned a profit of Rs." + profit[0] +" with profit percentage " +profit[1].toFixed(5)+"%";
        ...
        var msg =  "Oops! You had a loss of Rs." +loss[0] +" with loss percentage " +loss[1].toFixed(5)+"%";
